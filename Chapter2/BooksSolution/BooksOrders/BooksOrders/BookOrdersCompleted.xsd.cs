namespace BooksOrders {
    ...
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::BooksOrders.PropertySchema.OrderID), XPath = @"/*[local-name()='BookOrdersCompleted' and namespace-uri()='http://FlatFileWizard.BookOrdersCompleted']/*[local-name()='Header' and namespace-uri()='']/*[local-name()='OrderID' and namespace-uri()='']", XsdType = @"string")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"BookOrdersCompleted"})]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"BooksOrders.PropertySchema.PropertySchema", typeof(global::BooksOrders.PropertySchema.PropertySchema))]
    public sealed class BookOrdersCompleted : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://FlatFileWizard.BookOrdersCompleted"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns0=""https://BooksOrders.PropertySchema"" targetNamespace=""http://FlatFileWizard.BookOrdersCompleted"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      ...
      <b:imports>
        <b:namespace prefix=""ns0"" uri=""https://BooksOrders.PropertySchema"" location=""BooksOrders.PropertySchema.PropertySchema"" />
      </b:imports>
    </xs:appinfo>
  </xs:annotation>
